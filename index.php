 ...
 <body>
  ...
  <div class="panel-body">
     ...
     <form action="user_recommendation.php">
       ...
       <input type="submit" name="show_gifts" class="btn btn-primary" value="Show Euclidean Based Recommendation">
       <input type="hidden" name="id" value="<?php echo $row['id'] ?>">
    ...
    <td>
    <form action="cosine_recommendation.php">

      <input type="submit" name="show_gifts" class="btn btn-primary" value="Show Cosine Based Recommendation">
      <input type="hidden" name="id" value="<?php echo $row['id'] ?>">
